...
# Use the Kurage canonical avatar frames directly so Kurage Voice Pro, Kurage,
# kvtuber, and Montage-rendered videos do not drift into different copies.
VTUBER_AVATAR_LIPSYNC_DIR = Path(os.environ.get("KURAGEVP_VTUBER_AVATAR_LIPSYNC_DIR", "/home/kojima/work/kurage/images/avatar_lipsync"))
...
VTUBER_AVATAR_SHIFT_RIGHT_CHARS = env_int("KURAGEVP_VTUBER_AVATAR_SHIFT_RIGHT_CHARS", 2)
VTUBER_SUBTITLE_MARGIN_L = env_int("KURAGEVP_VTUBER_SUBTITLE_MARGIN_L", 28)
VTUBER_SUBTITLE_MARGIN_R = env_int("KURAGEVP_VTUBER_SUBTITLE_MARGIN_R", 216)
VTUBER_SUBTITLE_CJK_LINE_CHARS = env_int("KURAGEVP_VTUBER_SUBTITLE_CJK_LINE_CHARS", 16)
VTUBER_SUBTITLE_LATIN_LINE_CHARS = env_int("KURAGEVP_VTUBER_SUBTITLE_LATIN_LINE_CHARS", 40)
...
SUBTITLE_SHIFT_RIGHT_CHARS = env_int("KURAGEVP_SUBTITLE_SHIFT_RIGHT_CHARS", 0)
SUBTITLE_SHIFT_UP_LINES = env_int("KURAGEVP_SUBTITLE_SHIFT_UP_LINES", 2)
