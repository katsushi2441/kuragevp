...
PORT = int(os.environ.get("KURAGEVP_PORT", "18202"))
...
WHISPER_DEVICE = os.environ.get("KURAGEVP_WHISPER_DEVICE", "cpu")
WHISPER_COMPUTE_TYPE = os.environ.get("KURAGEVP_WHISPER_COMPUTE_TYPE", "int8")
